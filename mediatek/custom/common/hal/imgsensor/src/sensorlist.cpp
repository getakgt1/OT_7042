...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    RAW_INFO(OV8865_SENSOR_ID, SENSOR_DRVNAME_OV8865_MIPI_RAW,CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW, NULL /*CAM_CALGetCalData_OV5648*/), 
#endif
#if defined(OV5648AF_MIPI_RAW)
...
#endif
#if defined(GC2035_YUV)//liwenyuan add for yaris_xxl
    YUV_INFO(GC2035_SENSOR_ID, SENSOR_DRVNAME_GC2035_YUV,NULL),
#endif
#if defined(OV8850_MIPI_RAW)//zuoyong add for eclipse
...
#endif
#if defined(OV8858_MIPI_RAW)//zuoyong add for eclipse
