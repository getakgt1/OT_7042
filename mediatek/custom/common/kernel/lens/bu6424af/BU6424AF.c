...
//#define GPIO_CAMERA_AF_EN_PIN GPIO43
...
static int s4BU6424AF_ReadReg(unsigned short * a_pu2Result)
{
    ...
    BU6424AFDB("[liwenyuan]s4BU6424AF_ReadReg!i4RetValue=%d\n",i4RetValue);    
    ...
    *a_pu2Result = (((u16)pBuff[0]) << 4) + (pBuff[1] >> 4);
    BU6424AFDB("[liwenyuan]s4BU6424AF_ReadReg!a_pu2Result=%d\n",*a_pu2Result);    
    return 0;
}
...
static int s4BU6424AF_WriteReg(u16 a_u2Data)
{
    ...
    BU6424AFDB("[liwenyuan]s4BU6424AF_WriteReg !a_u2Data=%d\n",a_u2Data);    
...
inline static int getBU6424AFInfo(__user stBU6424AF_MotorInfo * pstMotorInfo)
{
    ...
    BU6424AFDB("[liwenyuan]getBU6424AFInfo !\n");    
...
{
    int ret = 0;
    BU6424AFDB("[liwenyuan]moveBU6424AF !a_u4Position=%d\n",a_u4Position);    
...
{
    int  i4RetValue = 0;
    BU6424AFDB("[BU6424AF] [liwenyuan]BU6424AF_Open - Start\n");
    ...
    {
        spin_unlock(&g_BU6424AF_SpinLock);
        BU6424AFDB("[BU6424AF][liwenyuan] the device is opened \n");
        return -EBUSY;
    }
...
char puSendCmd4[2]={(char)(0x8C),(char)(0x63)};//105Hz,Fastest mode
    mt_set_gpio_mode(GPIO_CAMERA_AF_EN_PIN,GPIO_MODE_00);
		mt_set_gpio_dir(GPIO_CAMERA_AF_EN_PIN,GPIO_DIR_OUT);
		mt_set_gpio_out(GPIO_CAMERA_AF_EN_PIN,1); i4RetValue = i2c_master_send(g_pstBU6424AF_I2Cclient, puSendCmd1, 2);	
    BU6424AFDB("[BU6424AF] [liwenyuan]BU6424AF_Open - i4RetValue=%d,line=%d\n",i4RetValue,__LINE__);
...
{
    BU6424AFDB("[BU6424AF][liwenyuan] BU6424AF_Release - Start\n");
    ...
    BU6424AFDB("[BU6424AF] [liwenyuan]BU6424AF_Release - End\n");
...
inline static int Register_BU6424AF_CharDrv(void)
{
    ...
    BU6424AFDB("[BU6424AF] [liwenyuan]Register_BU6424AF_CharDrv - Start\n");

    //Allocate char driver no.
    if( alloc_chrdev_region(&g_BU6424AF_devno, 0, 1,BU6424AF_DRVNAME) )
    {
        BU6424AFDB("[BU6424AF][liwenyuan] Allocate device no failed\n");
    ...
    if(NULL == g_pBU6424AF_CharDrv)
    {
        ...
        BU6424AFDB("[BU6424AF][liwenyuan] Allocate mem for kobject failed\n");
    ...
    {
        BU6424AFDB("[BU6424AF] [liwenyuan]Attatch file operation failed\n");
    ...
    BU6424AFDB("[BU6424AF] [liwenyuan]Register_BU6424AF_CharDrv - End\n");    
    return 0;
}

inline static void Unregister_BU6424AF_CharDrv(void)
{
    BU6424AFDB("[BU6424AF] [liwenyuan]Unregister_BU6424AF_CharDrv - Start\n");
    ...
    BU6424AFDB("[BU6424AF][liwenyuan] Unregister_BU6424AF_CharDrv - End\n");    
}
