...
void Document::addListenerTypeIfNeeded(const AtomicString& eventType)
{
    ...
    else if (eventType == eventNames().animationstartEvent)
        addListenerType(ANIMATIONSTART_STD_LISTENER);
    else if (eventType == eventNames().animationendEvent)
        addListenerType(ANIMATIONEND_STD_LISTENER);
    else if (eventType == eventNames().animationiterationEvent)
        addListenerType(ANIMATIONITERATION_STD_LISTENER);
