...
// standard events
    ...
    } else if (attr->name() == onanimationstartAttr) {
        setAttributeEventListener(eventNames().animationstartEvent, createAttributeEventListener(this, attr));
    } else if (attr->name() == onanimationiterationAttr) {
        setAttributeEventListener(eventNames().animationiterationEvent, createAttributeEventListener(this, attr));
    } else if (attr->name() == onanimationendAttr) {
        setAttributeEventListener(eventNames().animationendEvent, createAttributeEventListener(this, attr));
    ...
    } else if (attr->name() == ontransitionendAttr) {
        setAttributeEventListener(eventNames().transitionendEvent, createAttributeEventListener(this, attr));
