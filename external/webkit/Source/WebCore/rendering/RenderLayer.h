...
public:
    ...
    bool isStackingContext() const {
      ...
      if (hasOverflowScroll())
          return true;
#endif
      return !hasAutoZIndex() || isRootLayer() || (isComposited() && isFixed());
    }
#else
#if ENABLE(ANDROID_OVERFLOW_SCROLL)
    bool isStackingContext() const { return !hasAutoZIndex() || isRootLayer() || hasOverflowScroll(); }
#else
    bool isStackingContext() const { return !hasAutoZIndex() || isRootLayer() ; }
#endif
#endif
